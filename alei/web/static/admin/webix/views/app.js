define([
	...
	var mainToolbar = {
		...
		elements:[
			{view: "label", label: "Bi System", width: 200},
			{ height:46, id: "person_template", css: "header_person", borderless:true, width: 180, data: {id:3,name: "我的帐号"},
				template: function(obj){
					var html = 	"<div style='height:100%;width:100%;' onclick='webix.$$(\"profilePopup\").show(this)'>";
					html += "<img class='photo' src='/static/admin/webix/assets/imgs/photos/"+obj.id+".png' /><span class='name'>"+obj.name+"</span>";
